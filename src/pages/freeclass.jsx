...
import fredemo from "../Images/logo-single.svg";
          ...
          <div class="row justify-content-start">
            <div class="col-md-6">
              <div class="row row-eq-height form-contain-home form-right-content">
                <h5 class="w-100 mb-2 text-center">
                  Register for Free Stock Market Class
                </h5>
                <br></br>
                <p class="mb-3 text-center">
                  Fill This Form To Enter in Free Stock Market Class
                </p>
                <form class="row justify-content-start">
                  ...
                  <div class="col-md-6">
                    <div class="field input-field">
                      <input
                        class="form-contain-home-input"
                        type="text"
                        name="name"
                        placeholder=" Full Name"
                        required=""
                        fdprocessedid="n91dbi"
                      />
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12 mt-3 text-center">
                    ...
                    <div class="btn-holder-contect ">
                      <button
                        ...
                        name="freeLiveDemo"
                        value="submit"
                        class="btn btn-primary-grad"
                        fdprocessedid="cfkac97"
                      >
                        Submit
                      </button>
                    </div>
            ...
            <div class="col-md-6">
              <h4 class="w-100 text-center ">
                Benefit Of Stock Market Free Class
              </h4>
              <ul class="pl-5 mt-5">
